...
export default function AnalyticsPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className={`text-2xl font-bold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>Expense Analytics</h1>
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <Select value={timeRange} onValueChange={setTimeRange}>
                  <SelectTrigger
                    className={`w-[120px] h-9 ${theme === "dark" ? "bg-gray-700/50 border-gray-600 text-white" : "bg-gray-100 border-gray-300 text-gray-900"}`}
                  >
